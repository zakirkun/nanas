...
-- Expression UNIQUE is not allowed inside CREATE TABLE — use a unique index instead.
CREATE UNIQUE INDEX IF NOT EXISTS idx_functions_project_name_lower ON functions (project_id, lower(name));
